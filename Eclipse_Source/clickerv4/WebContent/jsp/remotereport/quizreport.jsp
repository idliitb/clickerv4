...
String calendarDate = reportHelper.getCalendarDate(WorkshopID, "quizCondectedDate", CoordinatorID.toString());			
	...
	<body class="ui-Mainbody" style="width:100%; height:100%; text-align: center;">
		...
		<table class="table1" style="margin-top:8px;" border="1" >
			<tr ><td width="20%">
				...
				<input type="text" id="quiz_datepicker"	style="width: 85px;" onchange="fillQuiz('<%=WorkshopID%>', this.value, '<%=dates%>')" ><br><br>
				<div id=quizname>
