...
This jsp file is used for quiz dashboard of principal
--%>
<%--
@Credit - Highcharts
...
<html>
	<head>
		...
		<script src="../../js/principalreportdashboard.js"></script>			
	</head>
		...
		<table class="table1">
			<tr ><td >
				<div id="qtype" style="display: inline; margin-left: 20px;">
					...
					<input type="button" value="Compare Course" onclick="return compareCourses()">
				</div>
				<div class="ui-header-text"  style="display: inline;margin-left: 140px;"><h2 style="display: inline;">Principal Dash-board</h2></div>
			</td></tr>
		</table>
		<!-- <div id="AllDeptChart" style="margin: auto;min-height:260px; width: 1000px;"></div> -->	
		<div id="HODDashboard">
		</div>		
