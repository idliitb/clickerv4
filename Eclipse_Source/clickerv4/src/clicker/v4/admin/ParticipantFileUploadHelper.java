/* Author : Gobianth M
 * Use :for upload the xls file in server   
 *  
 */
 ...
 */
//@WebServlet("/participantfileuploader")
public class ParticipantFileUploadHelper extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ParticipantFileUploadHelper() {
        super();
		...
		if(fileFlag){
			...
			for(FileItem item:items){
				if(!item.isFormField()&&!item.getName().equals("")){
					...
					System.out.println("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"+session.getAttribute("CoordinatorID"));
					//System.out.println("Pathurl: " + pathurl);
					String CID=(String)session.getAttribute("CoordinatorID");
					file=new File(pathurl + "/" +CID+fileName);
