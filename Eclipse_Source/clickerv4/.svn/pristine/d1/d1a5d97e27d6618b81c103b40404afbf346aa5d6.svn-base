...
<html>
	...
	<body class="ui-Mainbody" style="width:100%; height:100%; text-align: center;">
		...
		<table class="table1">
			<tr ><td >
				<div class="ui-header-text" ><h2>Course Report</h2></div>
			</td></tr>
		</table>
		<table class="table1" style="margin-top:8px;" border="1" >
			<tr ><td width="20%">
				<span style="margin-left:10px;"></span><input type="radio" value="StudentList" name="courserpt"  onchange="courseDetail()"/>
				<label>Student list</label><br><br>
				...
				<div id="courseAttDate" style="display: none;">
					...
					<input type="text" id="courseAtt_datepicker" style="width: 85px;" onchange="fillAttenDetail('<%=courseID%>', this.value)"/><br><br>
				</div>
				...
				<span style="margin-left:10px;"></span><input type="radio" value="QuizSummary" name="courserpt" onchange="courseDetail()"/>
				<label>Quiz summary</label><br><br>
				<span style="margin-left:10px;"></span><input type="radio" value="StudentQuery" name="courserpt" onchange="courseDetail()"/>
				<label>Student query</label><br><br>
				<div id="studentQueryDate" style="display: none;">
					<label style="margin-left:35px;">Date :</label>&nbsp;
					<input type="text" id="studentQuery_datepicker" style="width: 85px;"/>
				</div>
				<div id="hide_querydates" style="display: none;"><%=raiseHand_dates%></div>
				<button class="ui-conductquiz-button" id="coursereport_btn" type="button" style="margin-left: 50px;" onclick="coruseRport('<%=courseID%>')">
