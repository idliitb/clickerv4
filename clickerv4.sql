...
--
-- Current Database: `aakashclicker`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `aakashclicker` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Instant question with different questin type';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `instantquiznew` (
  ...
  PRIMARY KEY (`IQuizID`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Instant quiz with more question and different question type';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Current Database: `remoteaakashclicker`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `remoteaakashclicker` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `instantquestion` (
  ...
  `CorrectAns` char(6) NOT NULL,
  `IQuizID` int(5) NOT NULL,
  PRIMARY KEY (`IQuestionID`,`IQuizID`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Instant question with different questin type';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2014-05-15 14:54:07
